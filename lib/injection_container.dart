...
import 'package:linkyou/features/gallery_feature/data/repositories/user_repository_impl.dart';
...
import 'package:linkyou/features/gallery_feature/presentaion/cubit/user/remote/cubit/remote_user_cubit.dart';
...
Future<void> initDependencies() async {
  ...
  getIt.registerSingleton<PostUserUseCase>(PostUserUseCase(getIt()));

  getIt.registerFactory<RemoteUserCubit>(() => RemoteUserCubit(getIt(),getIt()));
}
